...
**Related skills files:** scenes.md, loading-assets.md, scale-and-responsive.md
...
Only the first scene starts automatically. Others start only if they have `{ active: true }` in their scene config. See scenes.md.
...
| `scene` | `SceneType\|SceneType[]` | `null` | Scene class, config object, or array of scenes |
